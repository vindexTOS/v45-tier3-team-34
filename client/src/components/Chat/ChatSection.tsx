    ...
    >
      {messages &&
        ...
        messages.map((val: any) => {
          ...
          const messageClasses = `px-10 max-h-[500px] max-w-[250px] w-fit rounded-[50px] break-all py-2 ${
            isUserMessage
              ? 'bg-green-400 dark:bg-green-600 text-white self-start rounded-bl-none'
