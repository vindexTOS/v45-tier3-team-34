...
const Portfolio_Preview = () => {
  ...
  const stateArray: stateArrayType[] = [
    ...
    { title: 'Description', value: description, type: 'description' },
    { title: 'Role', value: role, type: 'role' },
    { title: 'Github', value: github || '', type: 'github' },
    { title: 'Live Link', value: liveLink || '', type: 'liveLink' },
    { title: 'Video', value: video || '', type: 'video' },
  ]
  return (
    <section className={style.section}>
      ...
      <div className={style.stateDiv}>
        {stateArray.map((val: stateArrayType) => (
          <Portfolio_Change_TextArea key={val.title} originalState={val} />
        ))}
      </div>
      <div className={style.imgDiv}>
        <img
          className={style.img}
          src={ImgState.imgUrl}
          onClick={() => navigate('/dev_project_add/details')}
        />
        <TbPhotoEdit
          onClick={() => navigate('/dev_project_add/details')}
