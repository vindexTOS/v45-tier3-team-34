...
const CategoryHero = () => {
  return (
    <section className="bg-primary dark:bg-green-800 text-white flex justify-between flex-col lg:flex-row rounded-lg md:px-5 py-4 gap-y-5">
      <article className="flex flex-col px-5 gap-y-4 justify-center lg:px-12 ">
        ...
        <p className="text-lg sm:text-xl md:text-2xl max-w-xl font-thin">
          Hire junior developers to shorten
          development cycles, and drive product
          growth.
        </p>
        {/* button or link ?? */}
        <Link
      ...
      <article className="px-5">
        <img
          ...
          src="/assets/img/category_hero-img.png"
          alt="hero"
        />
      </article>
    </section>
