...
const User_Side = ({
  ...
  const style = {
    mainDiv: `w-full md:w-fit px-8 md:border-r-[1px] border-gray-300  flex items-center justify-center md:justify-start py-10 flex-col gap-2 text-primary`,
    aTeg: `flex items-center justify-center py-2 w-full md:w-fit min-w-[120px] border-2 border-green-900/40 dark:border-gray-600 rounded-3xl bg-green-600/10 dark:bg-gray-300/10 dark:hover:bg-gray-400/40  gap-2 hover:bg-secondary  hover:shadow-sm dark:shadow-gray-100/50   text-green-900 hover:text-slate-200 dark:text-green-600 hover:dark:text-gray-300 hover:scale-x-105 cursor-pointer`,
