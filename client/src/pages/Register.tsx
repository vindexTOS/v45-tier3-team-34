  ...
  return (
    <main className="w-full flex flex-col md:flex-row place-content-center ">
        ...
        <article className="flex justify-between mb-4 sm:mb-20">
            <a href="/" className="text-xg md:text-2xl font-extrabold text-gray-800">devConnect</a>
            <h1 className="text-sm text-gray-800 font-extralight">went</h1>
        </article>
        
        {/* title */}
        <article className="my-6 sm:my-24">
            <h1 className="text-3xl md:text-2xl font-light md:font-semibold">Create a free account</h1>   
        </article>
            {/* form here  */}
              <article className="flex flex-col gap-y-2 xl:mr-20">
                  ...
                  <button
                      ...
                      className="mt-2 bg-red-600 py-4 px-4 outline-none border-none rounded-sm font-semibold text-sm text-white">create account</button>
                  <a
